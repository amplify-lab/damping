...
Not yet built: Phase 3's full enterprise Gateway (OAuth 2.1, confused-deputy defense), Phase 4's Cloudflare-based team dashboard, Phase 5's enterprise/compliance tier — see [`docs/enterprise-architecture-research.md`](docs/enterprise-architecture-research.md) for infra research already done on these. Engineering-level detail on everything above lives in [`CLAUDE.md`](CLAUDE.md), not here.
