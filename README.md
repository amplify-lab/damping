...
Not yet built: Phase 3's full enterprise Gateway (OAuth 2.1, confused-deputy defense), Phase 4's Cloudflare-based team dashboard, Phase 5's enterprise/compliance tier — see `docs/00-統一開發計畫（定案版）.md` for the roadmap. Engineering-level detail on everything above lives in [`CLAUDE.md`](CLAUDE.md), not here.
